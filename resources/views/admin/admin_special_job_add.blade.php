...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container">
                <form role="form" method="POST" action="{{ route('admin.special_add_db') }}" class="form-container">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>特集求人イトル</label>
                                        <input type="text" class="form-control @error('special_title') is-invalid @enderror" name="special_title">
                                        @error('special_title')
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>特集求人内容</label>
                                        <textarea class="form-control editor" name="special_content" rows="5"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="">勤務地</label>
                                    <select name="special_area" class="form-control">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <button type="submit" class="btn btn-block btn-primary btn-lg col-md-4 offset-md-4">特集求人追加</button>
                            </div>
                        </div>
                    </div>
                </form>
