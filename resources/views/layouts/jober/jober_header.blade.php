                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                <li role="presentation" class="drop-item">
                                    <a role="menuitem" tabindex="-1" href="{{ route('jober.dashboard') }}">
                                        <i class="fa fa-id-badge "></i>マイページ</a>
                                </li>
{{--                                <li role="presentation" class="drop-item">
...
--}}
                                <li role="presentation" class="drop-item">
                                    <a role="menuitem" tabindex="-1" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                        ...
                                        <i class="fa fa-power-off"></i>ログアウト</a>
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                                        @csrf
                                    </form>
                                </li>
            ...
            <nav class="navbar below">
                <ul class="clearfix">
                    <li><a href="{{ route('jober.job_register') }}" class="btn"><span class="add">+</span>求人作成</a></li>
                    <li><a href="{{ route('jober.dashboard') }}">求人リスト</a></li>
                    <li><a href="{{ route('jober.hire_list') }}">採用者リスト</a></li>
                    <li><a href="{{ route('jober.bid_list') }}">応募者リスト</a></li>
                    <li><a href="{{ route('jober.jober_profile') }}">会社・店舗情報</a></li>
                </ul>
            </nav>
