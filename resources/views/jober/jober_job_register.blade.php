    ...
    <div class="container">
        <div class="col-lg-12">
            <section class="content-box mt-5">
                ...
                <p class="alert alert-{{$msg}}">{{ Session::get('alert-'.$msg) }} <a href="#" class="close" data-dismiss="alert" aria-label="close">
                ...
                <div class="box-content">
                    ...
                    <form action="{{ route('jober.job_register_db') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <table class="table table-data table-bordered profileTable">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="post_title" class="form-control" placeholder="例）ネットスーパーの宅配ドライバー／企業配のルート配送ドライバー ※具体的な職種を記入
　　・仕事内容（追加してください）
...
　　1日100〜150件程度の荷物をお届けしてもらいます。">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p><button type='button' id="post_other_exsample_button" class="exsample_button">記入例を見る</button></p>
                                        <div class="post_other_exsample_popup">
                                            <div class="post_other_exsample">
                                                <div class="post_other_exsample_text">例）軽バンを運転し、ECサイトで注文された商品の配送をお任せします。<br>
                                                    ...
                                                    はじめは既存のドライバーに同乗して配送の流れや現場のルールを覚えてもらいます。稼げるようになるまで責任を持って教育しますので、未経験の方も安心してご応募ください。<br>
                                                    ----- より詳しい仕事内容を追記したい場合は下記の要素を参考に追記してください -----<br>
                ...
                <table class="copyTable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($job['post_status'] === 0) 非公開 @endif
                                @if ($job['post_status'] === 1) 公開 @endif
                                @if ($job['post_status'] === 2) 掲載終了 @endif
                            </td>
                            <td>
...
<script>
    ...
    $('.post_pr_type').on('change', function() {
        ...
        $(this).nextAll('.post_pr_text').attr('');
        let placeholderText = '';
    ...
    $(document).ready(function() {
        // 1個目の削除ボタンを非表示にする
        $('.post_working_place_block:first').find('.post_working_place_delete').hide();
